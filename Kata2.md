...
when their paths is crossing. 

Fix this. If a rover sees that the cells where it should move it occupied it should not do it. 

### Rover back to the base

NASA added a nice feature it can ask any rover to go back to its original position.
